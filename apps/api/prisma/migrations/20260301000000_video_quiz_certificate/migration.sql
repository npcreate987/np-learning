...
CREATE TABLE "Quiz" (
    ...
    "title" TEXT NOT NULL DEFAULT 'แบบทดสอบท้ายคอร์ส',
...
-- AddForeignKey
ALTER TABLE "Certificate" ADD CONSTRAINT "Certificate_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Profile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
